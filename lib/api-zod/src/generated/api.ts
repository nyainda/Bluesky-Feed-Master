...
export const CreateFeedResponse = zod.object({
  "id": zod.number(),
  "recordName": zod.string(),
  "displayName": zod.string(),
  "description": zod.string().nullish(),
...
export const DeleteFeedResponse = zod.void()
...
export const AddFeedKeywordResponse = zod.object({
  "id": zod.number(),
  "feedId": zod.number(),
  "keyword": zod.string(),
  "createdAt": zod.string()
...
export const DeleteFeedKeywordResponse = zod.void()
...
export const GetFeedKeywordStatsResponse = zod.array(GetFeedKeywordStatsResponseItem)
...
export const GetFeedTopAuthorsResponse = zod.array(GetFeedTopAuthorsResponseItem)
...
export const GetTopPostsQueryParams = zod.object({
  ...
  "sortBy": zod.enum(['total', 'likes', 'reposts', 'replies']).default(getTopPostsQuerySortByDefault)
})
...
export const GetNotFollowingBackResponse = zod.array(GetNotFollowingBackResponseItem)
...
export const CreateScheduledPostResponse = zod.object({
  "id": zod.number(),
  "text": zod.string(),
  "threadParts": zod.string().nullish(),
  "isThread": zod.boolean(),
...
export const GetFollowerGrowthResponse = zod.array(GetFollowerGrowthResponseItem)
